...
## 导入docker镜像
服务在2021.8.4日、2022.7.14、2024.10.4和2025.10.11有重大升级，最新的版本从这里下载：x86_64镜像在[这里](http://static.wildfirechat.net/wildfire_janus_20c0347_amd64.tar)，下载完之后检查[md5](http://static.wildfirechat.net/wildfire_janus_20c0347_amd64.md5)；arm64镜像在[这里](http://static.wildfirechat.net/wildfire_janus_20c0347_arm64.tar)，下载完之后检查[md5](http://static.wildfirechat.net/wildfire_janus_20c0347_arm64.md5)
